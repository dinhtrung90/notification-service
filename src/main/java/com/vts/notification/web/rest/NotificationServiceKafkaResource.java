...
import com.vts.notification.config.KafkaProperties;
...
public class NotificationServiceKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NotificationServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NotificationServiceKafkaResource(KafkaProperties kafkaProperties) {
